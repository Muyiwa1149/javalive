...
// Rows as hardcoded in the source blade's indices spreads & trading
// conditions table. The Commission column has no source data (the source
// table only supplied 5 cells per row against a 5-header table, leaving
// Commission always blank), so it is rendered empty here too.
const indices = [
  { name: 'AUSTRALIA 200', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'EUROPE 50', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'FRANCE 40', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'GERMANY 30', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'HONG KONG 50', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'ITALY 40', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'JAPAN 225', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'NETHERLANDS 25', leverage: '1:200', lotSize: '1 * index price', minLotSize: '1', commission: '0' },
  { name: 'SPAIN 35', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'SWITZERLAND 20', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'UK 100', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'US 30', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'US 500', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
  { name: 'US TECH 100', leverage: '1:200', lotSize: '1 * index price', minLotSize: '0.01', commission: '0' },
]
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div class="mt-8 flex flex-wrap gap-4">
            ...
            <RouterLink to="/why-us" class="inline-flex items-center px-6 py-3 border border-gray-700 text-base font-medium rounded-md text-gray-300 bg-transparent hover:bg-gray-800 transition duration-300">
              Learn More
            </RouterLink>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="max-w-3xl mx-auto mb-8 relative">
        <div class="relative">
          ...
          <input v-model="searchQuery" type="text" class="block w-full pl-10 pr-3 py-3 border border-gray-700 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Search all instruments">
      ...
      <div class="relative">
        ...
        <div class="relative bg-gray-800 bg-opacity-80 backdrop-blur-sm rounded-xl p-6 overflow-hidden border border-gray-700">
          <div class="overflow-x-auto">
            <table class="display no-wrap tbl-spreads min-w-full divide-y divide-gray-700">
              <thead class="bg-gray-800">
                <tr>
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Symbol</th>
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Leverage</th>
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Lot Size</th>
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Min Lot Size</th>
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Commission</th>
                </tr>
              </thead>
              <tbody class="bg-gray-800 divide-y divide-gray-700 text-gray-200">
                <tr v-for="index in filteredIndices" :key="index.name" class="hover:bg-gray-700 transition-colors duration-150 ease-in-out">
                  <td class="px-6 py-4 whitespace-nowrap"><a class="text-blue-400 hover:text-blue-300" href="#">{{ index.name }}</a></td>
                  <td class="px-6 py-4 whitespace-nowrap">{{ index.leverage }}</td>
                  <td class="px-6 py-4 whitespace-nowrap">{{ index.lotSize }}</td>
                  <td class="px-6 py-4 whitespace-nowrap">{{ index.minLotSize }}</td>
                  <td class="px-6 py-4 whitespace-nowrap">{{ index.commission }}</td>
                </tr>
                <tr v-if="filteredIndices.length === 0">
                  <td colspan="5" class="px-6 py-8 text-center text-gray-500">No matching records found</td>
                </tr>
              </tbody>
            </table>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div class="mt-8">
            <RouterLink to="/terms" title="Learn About Trading Commissions" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 transition duration-300">
              Trading Conditions
        ...
        <div class="relative px-6 py-12 sm:py-16 sm:px-12 lg:px-16">
          <div class="md:ml-auto md:w-1/2 md:pl-10">
            ...
            <div class="mt-8 flex space-x-4">
              ...
              <RouterLink to="/register" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-800 bg-opacity-60 hover:bg-opacity-70 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Try Demo
              </RouterLink>
            </div>
          </div>
