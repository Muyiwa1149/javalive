...
// Hero text fade-in (mirrors the source's Alpine `isVisible` + x-transition).
const isVisible = ref(false)

// FAQ accordion — which item is expanded (mirrors the source's Alpine `selected`).
const selected = ref(null)
function toggle(i) {
  selected.value = selected.value !== i ? i : null
}
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(1)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
          ...
          <!-- FAQ Item 2 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(2)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
            ...
            <div v-show="selected === 2">
              <div class="px-6 pb-4 text-gray-300">
                <p>Yes, your MQL4 indicators and Expert Advisors can be converted to C#, for use on {{ settingsStore.settings?.siteName }} cTrader. Please contact a consultant from the <a class="text-blue-400 hover:text-blue-300" target="_blank" href="https://ctdn.com/consultants/">cTDN community</a>, who will be able to do this for you.</p>
              </div>
            </div>
          </div>
          ...
          <!-- FAQ Item 3 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(3)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
          ...
          <!-- FAQ Item 4 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(4)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
            ...
            <div v-show="selected === 4">
              <div class="px-6 pb-4 text-gray-300">
                <p>Once you download the cBot file, you will have to run and install it on your computer. You should then be able to view it on {{ settingsStore.settings?.siteName }} cTrader, at the left side of your chart under the cBots column. Once you define which instrument you'd like to run it for, click the "Play" button. The cBot will start working when the right conditions are met. Please note that you can stop it anytime, just by clicking the "Stop" button.</p>
              </div>
            </div>
          </div>
          ...
          <!-- FAQ Item 5 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(5)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
          ...
          <!-- FAQ Item 6 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(6)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
          ...
          <!-- FAQ Item 7 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(7)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
          ...
          <!-- FAQ Item 8 -->
          <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
            <button @click="toggle(8)" class="flex items-center justify-between w-full px-6 py-4 text-left focus:outline-none">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center gap-10">
          ...
          <div class="w-full md:w-1/2 space-y-8">
            ...
            <RouterLink to="/about" class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-200">
              Learn About {{ settingsStore.settings?.siteName }} Commissions
