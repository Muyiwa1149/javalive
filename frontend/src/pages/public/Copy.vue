...
// Hero text fade-in + the two Expert Support column fade-ins (mirror the source's three separate
// Alpine `isVisible` components, each triggered on a staggered setTimeout).
      ...
      <div class="relative z-10 px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col items-center text-center">
          <div class="w-full md:w-2/3">
            ...
            >
              <div v-if="heroVisible" class="space-y-6">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-6">
                  <RouterLink to="/register" class="px-6 py-3 text-base font-medium text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-200">
                    Get Started
                  </RouterLink>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="relative">
            ...
            >
              <div v-if="imageVisible" class="relative z-10">
          ...
          <div class="space-y-8">
            ...
            >
              <div v-if="contentVisible">
                ...
                <div class="mt-8">
                  <RouterLink to="/about" :title="`Learn About ${settingsStore.settings?.siteName} Trade Commissions`" class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 transition-all duration-200">
                    Learn More
          ...
          <div class="relative px-8 py-12 md:p-12 lg:px-16 lg:py-16">
            ...
            <div class="relative z-10 text-center max-w-2xl mx-auto">
              ...
              <div class="mt-8 flex justify-center">
                ...
                <RouterLink to="/login" class="ml-4 px-8 py-4 text-base font-medium text-white bg-transparent border border-white rounded-lg shadow-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-800 transition-all duration-200">
                  Login
                </RouterLink>
              </div>
            </div>
